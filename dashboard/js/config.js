function config() {
    return {
            ...
            cellData: 'https://api.github.com/repos/acycliq/ca1_no_single_cell_data_2/contents/dashboard/data/cellData',
            geneData: 'https://api.github.com/repos/acycliq/ca1_no_single_cell_data_2/contents/dashboard/data/geneData',
            cellCoords: 'https://api.github.com/repos/acycliq/ca1_dev/contents/dashboard/data/cellCoords',
